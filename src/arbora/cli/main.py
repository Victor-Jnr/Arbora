...
Commands:
  ...
  /prefs          Show or set user preferences (dry_run, provider, workday_folder, briefs_folder, projects_folder, downloads_folder, notes_folder, screenshots_folder, run_schedules_on_start, spoken_confirmations)
